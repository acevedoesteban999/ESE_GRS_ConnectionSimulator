...
public:
	...
	virtual char*getChar(){return NULL;};
	virtual unsigned getunsigned(){return 0;};
	virtual char* ActionAfterError(){return NULL;};
	virtual char* PricipalAction(){return NULL;};
...
public:
	...
	char* PricipalAction(){return ConnectClient();};
};
